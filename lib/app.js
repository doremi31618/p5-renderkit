...
export default class RenderKit{
...
export class ExperimentRenderKit extends RenderKit{
  ...
  drawColorCubes(color_code){
    this.clear();
    let colorBoard = new Colorboard(this.p5App, this.width, 5, color_code);
    this.contents.push(colorBoard);
  }
  drawRandomColorCubes(){
    //generate random color code
    let color_code = ColorCode.GenerateColorCode(25, this.numOfColorcube)
    // console.log("color code generate:", color_code);
...
let slider = addSlider("Main", "numOfColorcube", renderkit, 1,6);
displayAll();
