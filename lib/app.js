...
import {GenerateColorCode} from './Utilities/colorcode.js';
...
export class ExperimentRenderKit extends RenderKit{
  ...
  drawColorCubes(color_code){
    this.clear();
    let colorBoard = new Colorboard(this.p5App, this.width, 5);
    colorBoard.setColorCode(color_code);
    this.contents.push(colorBoard);
  }
  drawRandomColorCubes(){
    //generate random color code
    
    let color_code = GenerateColorCode()
