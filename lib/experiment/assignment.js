...
import { ExperimentRenderKit,createExperimentRenderKit,getExperimentRenderKit  } from '../renderkit/renderkit.js';
...
export class Assignment extends EventEmitter{
    ...
    InitializeAssignment(){
        ...
        this.renderkit = createExperimentRenderKit(this._colorboardSize, this._colorboardSize);
    ...
    InitializeScene(isAltColorCode, level, sceneConfig){
        ...
        this._altIndex = Math.floor(Math.random() * (this._colorboardLevel))
        ...
        this._cue_index = (sceneConfig.scene_2.use_cue || 
                          sceneConfig.scene_3.use_cue ||
                          sceneConfig.scene_4.use_cue) ? 
                          this.color_code_1.getColorSet(this._altIndex).index:-1;
        ...
        this._playerConfig.addLateScene('latescene', 
            sceneConfig.scene_3.duration/2, //duration
