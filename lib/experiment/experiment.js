...
document.eventBridge = new EventEmitter();
...
export class Experiment{
    ...
    initialize(){
        ...
        this._stage1_assignment_of_each_level = 1
    ...
    async _on_stage1_scene_end(){
        ...
        //write to here : write ui and record function
        ...
        if (this._trial >= this._stage1_assignment_number){
