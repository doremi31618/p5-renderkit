...
export class Experiment{
    ...
    saveRecord(_stage, response, answer){
        this.records.push(new AssignmentData({
            session: this.session,
            stage: _stage,
            trial: this._trial,
            subject_id: this.subject_id,
            associate_id: this.associtate_id,
            color_code_1: this.assignment.color_code_1,
            color_code_2: this.assignment.color_code_2,
