...
export class Experiment{
    ...
    getExperimentData(){
        return{
            ...
            experience_config: {
                stage1_min_level: this._stage1_min_level,
                stage1_max_level : this._stage1_max_level,
                stage1_assignment_number: this._stage3_assignment_number,
                stage1_assignment_of_each_level: this._stage1_assignment_of_each_level,
                stage2_assignment_number: this._stage2_assignment_number,
                stage3_assignment_number: this._stage3_assignment_number,
                stage4_assignment_answer: this._stage4_assignment_answer
            }
